...
public:
    ...
    double pt_resol(double pt, double eta, double phi, float nL, uint64_t event, uint32_t lumi) const;
...
private:
    ...
    double get_rndm(double eta, double phi, float nL, uint64_t event, uint32_t lumi) const;
